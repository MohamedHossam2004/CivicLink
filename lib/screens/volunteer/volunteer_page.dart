    ...
    return ListView(
      ...
      children: [
        _buildTaskCard(
          ...
          title: "Park Cleanup",
          description:
              "Help clean up Central Park by collecting trash and maintaining the green spaces.",
        ...
        _buildTaskCard(
          ...
          title: "Food Drive",
          description:
              "Collect and distribute food donations to local shelters and families in need.",
        ...
        _buildTaskCard(
          ...
          description:
              "Help elderly residents with grocery shopping, home maintenance, and companionship.",
        ...
        _buildTaskCard(
          ...
          title: "Tree Planting",
          description:
              "Plant new trees along Riverside Park to improve air quality and beautify the area.",
        ...
        _buildTaskCard(
          ...
          description:
              "Mentor young students in academic subjects and provide guidance for their future.",
    ...
    return ListView(
      ...
      children: [
        _buildTaskCard(
          ...
          description:
              "Maintain the community garden by watering plants, weeding, and harvesting vegetables.",
        ...
        _buildTaskCard(
          ...
          description:
              "Collect recyclable materials from residents and educate them about proper recycling practices.",
          location: "City Hall",
          date: "May 30, 2025",
    ...
    return ListView(
      ...
      children: [
        _buildTaskCard(
          ...
          title: "Beach Cleanup",
          description:
              "Cleaned up the local beach by removing trash and plastic waste.",
        ...
        _buildTaskCard(
          ...
          description:
              "Assisted healthcare workers in organizing and managing a community vaccination event.",
